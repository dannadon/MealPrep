...
//        tableView.insertRows(at: [indexPath], with: .automatic)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "Cell", for: indexPath) as! RecipeUITableCell
        let object = objects[indexPath.row] 

        cell.MasterRecipeNameLabel.text! = object.recipeName
        cell.MasterRecipeLabel.text! = object.recipe
        
        cell.recipeName = object.recipeName
        cell.recipe = object.recipe
